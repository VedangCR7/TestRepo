...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li> <a href="add-school.php"><i class="icon icon-signal"></i> <span>Add School</span></a> </li>
    <li> <a href="widgets.html"><i class="icon icon-inbox"></i> <span>Scheduled Email</span></a> </li>
    <li><a href="tables.html"><i class="icon icon-th"></i> <span>Add Template</span></a></li>
    <li><a href="grid.html"><i class="icon icon-fullscreen"></i> <span>Log</span></a></li>
		...
		<div class="span12">
			<div class="widget-box">
				...
				<div class="widget-content nopadding">
					<form action="add-school1.php" method="POST" class="form-horizontal" id="addschoolinfo" onsubmit="return validation();">
						<div class="span12">
							<div class="span6">
								<div class="control-group">
									<label class="control-label">School Name :</label>
									<div class="controls">
										<input type="text" class="span11" placeholder="School Name" id="name" name="name"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Email Id :</label>
									<div class="controls">
										<input type="email" class="span11" placeholder="Email Id" id="email" name="email" />
									</div>
								</div>
								<div class="control-group">
							...
							<div class="span6">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span11" placeholder="Status" id="status" name="status" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Comments :</label>
									<div class="controls">
										<textarea class="span11" id="comm" name="comm"></textarea>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Select Country</label>
									<div class="controls">
										<select class="span11" id="coun" name="coun">
										<?php 
											$c=new Country;
											$list=array();
											$list=$c->displayCountry();
						...
						<div class="form-actions">
							<button type="submit" class="btn btn-success" data-toggle="modal" data-target="#insertSchool" onclick="validation();"></button>
						</div>
					</form>
				</div>
		</div>
