			...
			<div class="row">
				<div class="col-lg-9">
					<div class="singlepost">
						<figure><img alt="" class="img-fluid" src="<?= $root_url; ?>/website_assets/webAssets/img/blog-single.jpg"></figure>
					...
					<div id="comments">
						...
						<ul>
							<li>
								<div class="avatar">
									<a href="#"><img src="<?= $root_url; ?>/website_assets/webAssets/img/avatar1.jpg" alt="">
									</a>
								</div>
								...
								<ul class="replied-to">
									<li>
										<div class="avatar">
											<a href="#"><img src="<?= $root_url; ?>/website_assets/webAssets/img/avatar4.jpg" alt="">
											</a>
										</div>
										<div class="comment_right clearfix">
											<div class="comment_info">
										...
										<ul class="replied-to">
											<li>
												<div class="avatar">
													<a href="#"><img src="<?= $root_url; ?>/website_assets/webAssets/img/avatar6.jpg" alt="">
													</a>
												</div>
												<div class="comment_right clearfix">
													<div class="comment_info">
						...
						if (mysqli_num_rows($result) > 0) {
						  ...
						  while($row = mysqli_fetch_assoc($result)) {
							...
							<li>
								...
								<h3><a href="blog-post.php?id=<?= $row['id']; ?>" title="" ><?php echo substr($row['title'],'0','30') ?>..</a></h3>
							</li>
