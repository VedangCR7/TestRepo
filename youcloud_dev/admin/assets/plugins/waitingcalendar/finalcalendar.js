...
(function (factory) {
    ...
    var clndrTemplate =
        ...
        "<table class='clndr-table' border='0' cellspacing='0' cellpadding='0'>" +
            "<tbody>" +
            "<% for(var i = 0; i < 1; i++){ %>" +
            "<tr class='changetrheight' style='height:10px !important'>"+
                "<% for(var j = 0; j < 7; j++){ %>" +
                "<% var d = j + i * 7; %>" +
                "<td class='<%= days[d].classes %>'>"+
                    "<div class='col-md-12 header-days'>"+
                        "<div class='col-md-12 text-center shortdayname' style='color:#EDEDED'>"+
                            "<%= days[d].dayname %>"+
                        "</div>"+
                    "</div>"+
                "</td>"+
            ...
            "<% for(var i = 0; i < numberOfRows; i++){ %>" +
                ...
                "<% var d = j + i * 7; %>" +
                    ...
                    "<td class='<%= days[d].classes %> btn-add-event'>" +
                        "<a class='btn-add-event <%= days[d].calendar_class %>' href='javascript:;'>"+
                        "<div class='day-contents mt-4 text-center'>"+
