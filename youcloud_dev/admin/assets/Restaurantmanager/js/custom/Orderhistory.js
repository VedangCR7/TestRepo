var Orderhistory ={
    ...
    bind_events :function() {
        ...
        // });
        // $('#footer_status_button').on('click','.btn-change-status',this.OnChangeStatus);ss
    },
            ...
            success: function(response){
                ...
                for (i in orders) {
                    ...
                    html+='<tr>';
                        ...
                        <td>'+Orderhistory.currency_symbol+' '+orders[i].net_total+'</td>';
            ...
            success: function(response){
                ...
                for (i in items) {
                    html+='<tr>\
                        ...
                        <td class="text-right">'+Orderhistory.currency_symbol+' '+items[i].price+'</td>';
                    html+='</tr>';
                    j=j+1;
                }
