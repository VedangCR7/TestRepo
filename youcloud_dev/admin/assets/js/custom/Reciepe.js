var Reciepe ={
	...
	if (Reciepe.recipe_price !== null) {   
            if ( Reciepe.recipe_price != $('.input-recipe-price').val() ) {
                console.log("run ajax", Reciepe.recipe_id);
                let sendData = {
                        price : $('.input-recipe-price').val(),
                        recipe_id : Reciepe.recipe_id
                    }
                debugger;
                $.ajax({
                    url: Reciepe.base_url+"recipes/save_price",
                    type:'POST',
                    dataType: 'json',
            ...
            $.ajax({
                ...
                success: function(result)
				{
					...
					{ 
                        ...
                        Reciepe.displaysucessconfrim("Information saved successfully.");
                    }
					else
					{
                        Reciepe.displaywarning(result.msg);
	...
	displaysucessconfrim:function(msg)
    {
        swal({
            ...
            buttonsStyling: false
                ...
                if(isconfirm){
                    window.location.href=Reciepe.base_url+'recipes/overview';
