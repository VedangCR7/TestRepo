            ...
            $.ajax({
                ...
                success: function(response){
                   ...
                   /* var allergens=response.result.linked.allergens;*/
                    var nutrients=response.recipe.nutrition;
                    $('.recipe-image').attr('src',Viewuser.base_url+response.recipe.recipe_image);
                    $('#image-loader').hide();
                    
                    var image="";
                    var html='';
                    if(response.recipe.allergens){
                        var allergens=response.recipe.allergens;
                        for(var i in allergens){
                            ...
                            html+='<div class="col-md-2 text-center">\
                                <img src="'+Viewuser.base_url+allergens[i].image_url+'">\
                                <p class="mt-2 text-center">'+allergens[i].title+'</p>\
                            </div>';
                        }
                    }
                    if(html=="")
