var Waiter ={
    ...
    assign_table_to_manager:function(){
        ...
        console.log(array);
        $.ajax({
            url: Waiter.base_url+"waiter/assign_table_to_manager",
            type:'POST',
    ...
    onassigntable:function(){
        ...
        console.log(restaurant_waiter_id)
        $.ajax({
            url: Waiter.base_url+"waiter/show_table_rest_manager",
            type:'POST',
                        ...
                        swal({
                            ...
                            if(swalinput){
                               ...
                               /* self.closest('td').find('.img-upload').attr('data-image-src',imageData);
                                ...
                                $.ajax({
                                    url: Waiter.base_url+"waiter/update_profile_photo",
                                    type:'POST',
                                    data: $form_data,
                                    processData:false,
                                    contentType:false,
    ...
    changeStatusManager:function(){
        ...
        $.ajax({
            url: Waiter.base_url+"waiter/delete_manager",
            type:'POST',
            data:formData ,
            success: function(result){
               if (result.status) {
    ...
    onDeleteManager:function(){
        ...
        swal({
            ...
            $.ajax({
                url: Waiter.base_url+"waiter/delete_perticular_restaurant_manager",
                type:'POST',
                data:formData ,
                success: function(result){
                   if (result.status) {
    ...
    onSaveGroupname:function(){
        ...
        if($('#name').val()!="" && $('#email').val()!="" && $('#contact_number').val()!=""){
            ...
            if ($('#profile_photo').val() != '') {
                $('#image-loader').show();
                $.ajax({
                    url: Waiter.base_url+"delivery/add_profile_photo",
                    type:'POST',
                    dataType: 'json',
                    data: {
                        name : $('#name').val(),
                    ...
                    success: function(result){
                        ...
                        if (result.status) {
                            if(result.is_email_exist){
                                ...
                                Waiter.displaysucess("Deliverer created successfully");
                                var data={
                                    per_page:$('.btn-per-page').attr('selected-per-page'),
                                    page:1
                                }
                ...
                $('#image-loader').show();
                $.ajax({
                    url: Waiter.base_url+"delivery/add_new_currier",
                    type:'POST',
                    dataType: 'json',
                    data: {
                        name : $('#name').val(),
    ...
    listmanager:function(data,fromevent){
        $.ajax({
            url: Waiter.base_url+"delivery/list_deliverers/",
            type:'POST',
            dataType: 'json',
            data: data,
