    ...
    showCartData:function(cart_details){
        ...
        for (i in cart_details) {
            ...
            html+='<tr>\
                    ...
                    <td style="width:20%" class="text-right"><div class="input-price"><input type="text" class="form-control updated_price" data-id="'+cart_details[i].id+'" rowid="'+cart_details[i].rowid+'" qty="'+cart_details[i].qty+'" value="'+cart_details[i].price+'"></div></td>\
                   </tr>';
