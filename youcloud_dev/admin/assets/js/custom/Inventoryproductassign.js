            ...
            html+='<tr>\
                    ...
                    <td style="width:20%">\
                        <div class="input-group input-indec">\
                            ...
                            <input type="text" name="quantity" min="0" max="'+cart_details[i].purchase_qty+'" class="form-control input-number text-center quantity" data-id="'+cart_details[i].id+'" rowid="'+cart_details[i].rowid+'" data-purchase_qty="'+cart_details[i].purchase_qty+'" value="'+cart_details[i].qty+'" style="width:1px;">\
                            <span class="input-group-btn">\
