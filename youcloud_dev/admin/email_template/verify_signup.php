					...
					<tr>
					 <td style="padding:30px 20px;padding-bottom:0;background:#ffffff;border:#dddddd solid 1px;border-bottom:none">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="font-family:arial;font-size:13px;color:#585455">
							<tbody>
								<tr>
									<td style="padding-bottom:15px">Almost Done, "User Name",</td>
								</tr>
								<tr>
									<td style="line-height:20px;padding-bottom:20px">						    
									    <p>
									    	To complete your FoodNAI sign up, we just need to verify your email address  <b><?=$email;?> </b>
 
									    </p>
									    <form method="post" id="form-verify-signup">
									    	<button class="btn btn-primary">Verify email address</button>
									    </form>
									    <p>
									    	Once verify, you can start using all of FoodNAI features to explore.
									    </p>
									</td>
								</tr>
