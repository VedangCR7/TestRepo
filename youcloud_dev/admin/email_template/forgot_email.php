		...
		<tbody>
		  <tr>
				...
				<tbody>
					<tr>		
						...
						<td align="center" style="width: 20%;">
							<a href="##base_url##"><img src="##base_url##assets/images/brand/logo.png" style="width: 100%;"></a>
						</td>
						<td width="40%"></td>
					...
					<tr>
					 <td style="padding:30px 20px;padding-bottom:0;background:#ffffff;border:#dddddd solid 1px;border-bottom:none">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="font-family:arial;font-size:13px;color:#585455">
							<tbody>
								<tr>
									<td style="padding-bottom:15px"><b>Hello ##name##,</b></td>
								</tr>
								<tr>
									<td style="line-height:20px;padding-bottom:20px">						    
									    <p>
									    	We've received a request to reset the password for your FoodNAI account. To reset your password please click on below button. This button takes you to a secure page where you can change your password.
									    </p>
									    <form method="post" id="form-reset-password" action="##base_url##forgot/reset_password" style="text-align: center;">
									    	<input type="hidden" name="id" value="##id##">
									    	<input type="hidden" name="email" value="##email##">
									    	<button class="btn btn-primary" style="display: inline-block;font-weight: 400;text-align: center;white-space: nowrap;vertical-align: middle;-webkit-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;border: 1px solid transparent !important;padding: 0.375rem 0.75rem;font-size: 0.9375rem;line-height: 1.84615385;border-radius: 3px;background-color: #ec6e09;color: #fff;border-color: #ec6e09;" type="submit">Reset your password</button>
									    </form>
									    <p>
									    	If you don't want to reset your password, please ignore this message. Your password will not be reset. For General inquiries or to request support with your account, please email us on <a style="color: blue;">help@foodnai.com</a>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="font-family:arial;font-size:13px;color:#797576">
				<tbody>
				  <tr>
					<td style="padding:20px 15px;background:#ffffff;border:#dddddd solid 1px;border-top:none">
					 <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="font-family:arial;font-size:13px;color:#797576">
						<tbody>
							<tr>
								<td style="line-height:20px;padding-bottom:15px;color:#686465">
									...
									<p style="padding-left: 15px;">Foodnai</p>
									<a href="##base_url##">
										<img src="##base_url##assets/images/brand/logo.png" style="width: 20%;">
									</a>		
								</td>
							</tr>
						</tbody>
				...
				<tr>
				 <td>
					<table width="400" style="text-align:center" align="center" cellspacing="0" cellpadding="0">
					 <tbody>
					    <tr>
							<td><a href="#" style="color:#585455;font-family:arial;font-size:12px;text-decoration:none;vertical-align:middle"><img src="##base_url##email_templates/images/mail.png" width="13" height="10" style="padding-right:10px;border:none;vertical-align:middle">help@foodnai.com</a>
							</td>
						</tr>
				       </tbody>
			        </table>
