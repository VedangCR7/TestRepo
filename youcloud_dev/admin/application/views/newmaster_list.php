	...
	<div class="row">
		<div class="col-md-12 mb-3">
			<div class="input-group">
				<input type="text" class="form-control" placeholder="Menu" id="AddMenuGroup" name="main_menu_id" style="font-size: 15px;">
				<input type="text" class="form-control" placeholder="Long Description" id="AddMenuGroupTime" style="font-size: 15px;">
				<input type="text" class="form-control" placeholder="Declaration Name" id="decname" style="font-size: 15px;">
				<!--<input type="file" id="imgupload" accept="image/jpeg" /> -->
						...
						<table class="table card-table table-vcenter text-nowrap table-head" id="table-recipes">
							<thead >
								<tr>
									<th>Image ID</th>
									<th>Image</th>
									<th style="max-width: 11%!important;">Menu</th>
									<th>Ingredients</th>
									<th></th>
								</tr>
							</thead>
...
?>
<script src="<?=base_url();?>assets/js/custom/Newmasterlist.js?v=2"></script>

<script type="text/javascript">
	Newmasterlist.base_url="<?=base_url();?>";
	Newmasterlist.init();
</script>