                ...
                <div class="row clearfix">
                    ...
                    <div class="featured-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="image-box">
                                <a href="<?=base_url();?>services"><img src="<?=base_url();?>assets/images/resource/featured-image-4.jpg" alt="" title=""></a>
                            </div>
                            <div class="lower-box">
                                <h3><a href="<?=base_url();?>services">Easier To Implement</a></h3>
                                ...
                                <div class="more-link"><a href="<?=base_url();?>services"><span class="fa fa-arrow-right"></span></a></div>
                            </div>
                        </div>
                    </div>
                    <!--Featured Block-->
                    <div class="featured-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="image-box">
                                <a href="<?=base_url();?>services"><img src="<?=base_url();?>assets/images/resource/featured-image-5.jpg" alt="" title=""></a>
                            </div>
                            <div class="lower-box">
                                <h3><a href="<?=base_url();?>services">Increase Growth Rates</a></h3>
                                <div class="text">Sed incididunt labore dolore magna sed aliq veniam quis ipsu nostrud exercitation ullamco sed ipsum venum.</div>
                                <div class="more-link"><a href="<?=base_url();?>services"><span class="fa fa-arrow-right"></span></a></div>
                            </div>
                        </div>
                    ...
                    <div class="featured-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="image-box">
                                <a href="<?=base_url();?>services"><img src="<?=base_url();?>assets/images/resource/featured-image-6.jpg" alt="" title=""></a>
                            </div>
                            <div class="lower-box">
                                <h3><a href="<?=base_url();?>services">Branding Of Future</a></h3>
                                <div class="text">Sed incididunt labore dolore magna sed aliq veniam quis ipsu nostrud exercitation ullamco sed ipsum venum.</div>
                                <div class="more-link"><a href="<?=base_url();?>services"><span class="fa fa-arrow-right"></span></a></div>
                            </div>
                        </div>
    ...
    <section class="locations-section">
        <div class="auto-container">
            ...
            <div class="map-box">
                <!--Map Image-->
                <div class="map-image">
                    <img src="<?=base_url();?>assets/images/icons/map-pattern.png" alt="" title="">
                </div>
    ...
    <section class="default-bg-section">
        ...
        <div class="auto-container">
            <div class="content-box">
                ...
                <div class="link-box">
                    <a href="<?=base_url();?>about" class="theme-btn btn-style-one"><div class="btn-title">Proven IT Solutions</div></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="team-section">
        ...
        <div class="auto-container">
                ...
                <div class="column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner">
                        ...
                        <div class="team-block wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="image-box">
                                    <a href="<?=base_url();?>about"><img src="<?=base_url();?>assets/images/resource/team-image-1.jpg" alt=""></a>
                                </div>
                                <div class="title-box">
                                    <h3 class="name"><a href="<?=base_url();?>about">Benjamin Zara</a></h3>
                ...
                <div class="column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner">
                        ...
                        <div class="team-block wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="image-box">
                                    <a href="<?=base_url();?>about"><img src="<?=base_url();?>assets/images/resource/team-image-2.jpg" alt=""></a>
                                </div>
                                <div class="title-box">
                                    <h3 class="name"><a href="<?=base_url();?>about">Amayda Tim</a></h3>
                        ...
                        <div class="team-block wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="image-box">
                                    <a href="<?=base_url();?>about"><img src="<?=base_url();?>assets/images/resource/team-image-3.jpg" alt=""></a>
                                </div>
                                <div class="title-box">
                                    <h3 class="name"><a href="<?=base_url();?>about">Paul Wilsona</a></h3>
            ...
            <div class="view-all link-box">
                <a href="<?=base_url();?>about" class="theme-btn btn-style-one"><div class="btn-title">View Full Team</div></a>
            </div>
        ...
        <div class="sponsors-outer">
            ...
            <div class="auto-container">
                ...
                <div class="sponsors-carousel theme-carousel owl-theme owl-carousel" data-options='{"loop": true, "margin": 30, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 500, "responsive":{ "0" :{ "items": "1" }, "600" :{ "items" : "2" }, "768" :{ "items" : "3" } , "800":{ "items" : "3" }, "1024":{ "items" : "4" }, "1200":{ "items" : "5" }}}'>
                    <div class="slide-item"><figure class="image-box"><a href="<?=base_url();?>#"><img src="<?=base_url();?>assets/images/clients/6.jpg" alt=""></a></figure></div>
                    <div class="slide-item"><figure class="image-box"><a href="<?=base_url();?>#"><img src="<?=base_url();?>assets/images/clients/7.jpg" alt=""></a></figure></div>
                    <div class="slide-item"><figure class="image-box"><a href="<?=base_url();?>#"><img src="<?=base_url();?>assets/images/clients/8.jpg" alt=""></a></figure></div>
                    <div class="slide-item"><figure class="image-box"><a href="<?=base_url();?>#"><img src="<?=base_url();?>assets/images/clients/9.jpg" alt=""></a></figure></div>
                    <div class="slide-item"><figure class="image-box"><a href="<?=base_url();?>#"><img src="<?=base_url();?>assets/images/clients/10.jpg" alt=""></a></figure></div>
                    <div class="slide-item"><figure class="image-box"><a href="<?=base_url();?>#"><img src="<?=base_url();?>assets/images/clients/6.jpg" alt=""></a></figure></div>
                    <div class="slide-item"><figure class="image-box"><a href="<?=base_url();?>#"><img src="<?=base_url();?>assets/images/clients/7.jpg" alt=""></a></figure></div>
                    <div class="slide-item"><figure class="image-box"><a href="<?=base_url();?>#"><img src="<?=base_url();?>assets/images/clients/8.jpg" alt=""></a></figure></div>
                    <div class="slide-item"><figure class="image-box"><a href="<?=base_url();?>#"><img src="<?=base_url();?>assets/images/clients/9.jpg" alt=""></a></figure></div>
