...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="side-menu__icon fe fe-watch mr-1"></i>Waitinglist</h3>
			<ol class="breadcrumb">
	...
	<div class="row mb-3 row-filter">
		<div class="col-md-2">
			<select class="form-control" id="assigndeclinechange">
...
<script src="<?=base_url();?>assets/js/custom/AssignWaitingmanager.js?v=2"></script>

<script type="text/javascript">
	AssignWaitingmanager.base_url="<?=base_url();?>";
	AssignWaitingmanager.init();
