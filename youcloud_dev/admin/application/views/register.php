...
<html lang="en" dir="ltr">
  <head>
		...
		<!-- Title -->
		<title>YouCloud - food allergen nutrition information</title>
		<!--Bootstrap.min css-->
...
body {
				...
				<div class="row">
					<div class="col  mx-auto">
						<div class="row justify-content-center">
							<div class="col-md-6">
								<div class="card-group mb-0 mt-6">
									<div class="card">
										<form method="post" action="javascript:;" id="register-form" name="registerform">
											<div class="card-body text-center">
												<div class="text-center mb-6">
													<img src="<?=base_url();?>assets/images/brand/FoodNAILoginLogo.png" class="" alt="Foodnai"  width="35%;">
												</div>
												<!-- <h3>Register</h3> -->
												<div class="row">
													<div class="col-md-12">
														...
														<div class="checkbox mb-3">
															<div class="custom-checkbox custom-control">
																<input type="checkbox" data-checkboxes="mygroup" class="custom-control-input" id="checkbox-2" name="terms_and_condition">
																<label for="checkbox-2" class="custom-control-label">I Agree the <a href="javascript:;">Terms and conditions</a></label>
															</div>
														</div>
													</div>
													<!-- <div class="col-md-6">
    ...
    //    }
		...
		<script type="text/javascript" src="<?=base_url();?>assets/js/custom/Login.js?v=2"></script>
