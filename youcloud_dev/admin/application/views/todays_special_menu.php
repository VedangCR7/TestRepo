...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="side-menu__icon fe fe-star mr-1"></i> Today's Special</h3>
			<ol class="breadcrumb">
				<li class="breadcrumb-item">Home</li>
				<li class="breadcrumb-item active" aria-current="page">Today's Special</li>
			</ol>
		</div>
		<!--Page Header-->
	</div>
		...
		<div class="col-md-7">
			<div class="input-group">
				...
				<span class="input-group-append">
					<button class="btn btn-primary" id="searchRecipeBtn" type="button" style="border-radius: 4px;"><i class="fas fa-search"></i></button>
				</span>
			</div>
		</div>
			...
			<div class="card">
				<div class="card-body">
					<div class="table-responsive">
						<tfoot>
							<button type="button" class="btn btn-info btn-recipe-restaurant" style="text-align: right;float: left;">Save </button>
						</tfoot>
...
?>
<script src="<?=base_url();?>assets/js/custom/Todayspecialmenu.js?v=<?php echo uniqid(); ?>"></script>
