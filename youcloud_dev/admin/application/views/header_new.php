        ...
        <div class="page">
            <div class="page-main">
                    ...
                    <div class="container-fluid">
                        <div class="d-flex">
                            ...
                            <a class="header-brand" href="<?php echo base_url().$url;?>">
                                <img alt="logo" class="header-brand-img main-logo" src="<?=base_url();?>assets/images/brand/FoodNAIHeaderLogo.png">
                           ...
                           <!--  <div class="dropdown d-sm-flex d-none">
                            ...
                            <div class="dropdown d-sm-flex d-none header-message">
                                    <a class="nav-link icon" data-toggle="dropdown">
                                        ...
                                        <span class=" nav-unread badge badge-warning  badge-pill new-order" id="new-order-count">0</span>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <audio id="newordersound" src="<?=base_url();?>assets/neworder.mp3" preload="auto"></audio>
                           ...
                           <!--      <div class="dropdown d-none d-md-flex">
                                ...
                                <div class="dropdown">
                                    <a class="nav-link pr-0 leading-none d-flex" data-toggle="dropdown" href="#">
                                        <?php
                                       if($_SESSION['profile_photo']=="" || $_SESSION['profile_photo']=="assets/images/users/user.png"){
                                       ?>
                ...
                <script>
                    ...
                    function gotoOrder(order_id,table_id,table_orders_id){
                        $.ajax({
                            type:"POST",
                            url:"updatevieworder",
                            ...
                            {   let res = JSON.parse(response);
                                if(res && res.success){
                                   //    getNewOrders();
                                    window.location.href='tablerecipe/'+table_id+'/'+table_orders_id;
                                }
