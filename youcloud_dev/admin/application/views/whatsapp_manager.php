...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="side-menu__icon fe fe-user mr-1"></i>Whatsapp Manager</h3>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Home</a></li>
				<li class="breadcrumb-item active" aria-current="page">Whatsapp Manager</li>
			</ol>
		</div>
		<!--Page Header-->
	</div>
	...
	<div class="row mb-3 row-filter">
		...
		<div class="col-md-5">
			<div class="input-group">
				<input type="text" class="form-control" placeholder="Search Whatsapp Manager"  id="searchInput" style="font-size: 17px;">
...
<script src="<?=base_url();?>assets/js/custom/Whatsappmanager.js"></script>

<script type="text/javascript">
	Whatsappmanager.base_url="<?=base_url();?>";
