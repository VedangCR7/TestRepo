...
use \Caps\Service\StripePayment;
...
if (!empty($_POST["token"])) {
    ...
    $paymentData;
	$paymentData['token']=$_POST["token"];
	$paymentData['name']=$_POST["name"];
	$paymentData['email']=$_POST["email"];
	$paymentData['card-number']=$_POST["card-number"];
	$paymentData['month']=$_POST["month"];
	$paymentData['year']=$_POST["month"];
	$paymentData['cvc']=$_POST["cvc"];
	$paymentData['amount']=$_POST["amount"];
	$paymentData['currency_code']=$_POST["currency_code"];
	$paymentData['item_name']=$_POST["item_name"];
	$paymentData['item_number']=$_POST["item_number"];
	$paymentData['description']=$_POST["item_name"];
	$paymentData["address"]=["city" => $_POST["city"], "country" => $_POST["country"], "line1" => $_POST["line1"], "line2" => $_POST["line2"], "postal_code" => $_POST["postal_code"], "state" => $_POST["state"]];
...
<body>
    ...
    <div id="error-message"></div>
            ...
            <form id="frmStripePayment" action=""
				...
				<div class="field-row">
					<label>Card Holder Country</label> <span
					id="card-holder-country-info" class="info"></span><br>
					<select id="country" name="country" class="demoInputBox" required>
				...
				<div class="field-row">
					<label>Card Holder State</label> <span
					id="card-holder-state-info" class="info"></span><br>
					<input type="text" id="state" name="state"
					class="demoInputBox" required>
				</div>
			   <div class="field-row">
					<label>Card Holder City</label> <span
					id="card-holder-city-info" class="info"></span><br>
					<input type="text" id="city" name="city"
					class="demoInputBox" required>
				</div>
				 <div class="field-row">
					<label>Card Holder Address Line1</label> <span
					id="card-holder-line1-info" class="info"></span><br>
					<input type="text" id="line1" name="line1"
					class="demoInputBox" required>
				</div>
				<div class="field-row">
					<label>Card Holder Address Line2</label> <span
					id="card-holder-line2-info" class="info"></span><br>
					<input type="text" id="line2" name="line2"
					class="demoInputBox">
				</div>
				<div class="field-row">
					<label>Card Holder Postal Code</label> <span
					id="card-holder-postal_code-info" class="info"></span><br>
                ...
                <input type='hidden' name='amount' value='0.5'> <input
                    type='hidden' name='currency_code' value='<?php echo CURRENCY;?>'> <input
