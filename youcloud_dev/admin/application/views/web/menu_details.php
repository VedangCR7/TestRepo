                            ...
                            <?php
                                        ...
                                        if($best_time_to_eat != ''){ 
                                            ...
                                            <span class="badge badge-danger" style="background-color:#C70039;">Best Time To Eat : </span> 
                                              <small><?php echo ucwords($best_time_to_eat); ?></small><br>
                                       <?php }
                                       else{
                                        ?>
                                        <span class="not-besttime-toeat">
                                        </span> 
                                        <?php
                                       }
                                        ?>
    ...
    <script type="text/javascript">
       ...
       $(document).ready(function() {
			...
			if((fresid == '58') || (fresid == '86')){
				...
				$.ajax({ 
						type : 'POST',
						url : 'http://3.6.145.242/ws/menuallergendetails.php',
       ...
       <!-- <script type="text/javascript">
            function googleTranslateElementInit() {
                new google.translate.TranslateElement({ pageLanguage: 'en', includedLanguages: 'en,mr,hi,el', multilanguagePage: true}, 'google_translate_element');
