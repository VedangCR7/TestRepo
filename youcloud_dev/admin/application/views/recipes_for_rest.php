...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="side-menu__icon fas fa-utensils mr-1"></i> Recipes Overview</h3>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Home</a></li>
				<li class="breadcrumb-item active" aria-current="page">Recipes Overview</li>
			</ol>
		</div>
		<!--Page Header-->
	</div>
...
?>
<script src="<?=base_url();?>assets/js/custom/Reciperestlist.js"></script>

<script type="text/javascript">
	Reciperestlist.base_url="<?=base_url();?>";
	Reciperestlist.group_id="<?php if(isset($_GET['group_id'])) echo $_GET['group_id']; else echo '';?>";
	Reciperestlist.init();
