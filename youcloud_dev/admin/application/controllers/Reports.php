...
class Reports extends MY_Controller {
	...
	public function price_change_sales_report(){
		$data['recipes_all'] = $this->recipes_model->list_recipes_typahead();
		$data['restaurantsidebarshow'] =$this->get_menu_of_restaurant();
		return $this->load->view('price_qty_sales_report.php', $data);
	}
