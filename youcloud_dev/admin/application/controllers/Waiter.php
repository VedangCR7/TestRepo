...
class Waiter extends MY_Controller {
	...
	public function waiter_list() {
		...
		$this->load->view('waiter_list',$data);
	}

	public function list_manager(){
		if(isset($_POST['searchkey']))
			$manager=$this->Waiter_model->list_manager($_POST['page'],$_POST['per_page'],$_POST['searchkey']);
		else
		$manager=$this->Waiter_model->list_manager($_POST['page'],$_POST['per_page']);
