...
<!-- SPECIFIC CSS -->
<link href="<?= $root_url; ?>/website_assets/webAssets/css/help.css" rel="stylesheet">

	<main>
		<div class="hero_single inner_pages background-image" data-background="url(<?= $root_url; ?>/website_assets/webAssets/img/hero_general_2.jpg)">
