                ...
                success: function(response){
                    if(response.status){
                        ...
                        if(response.msg=="Already Selected")
                            displaywarning("This group already selected for "+$('#selected-date-text').html());
                    }
                }
            });
        });
                        ...
                        html+='<div class="col-md-4">\
                            <div class="form-group">\
                                <label class="custom-control custom-checkbox">\
                                    <input type="checkbox" class="custom-control-input checkbox-recipe" name="recipe_chk'+i+'" value="'+result[i].id+'" checked>\
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    for(var i in nutrients){
                        $('#'+i).html(nutrients[i].value+''+nutrients[i].unit);
                    }
                    $('#servingsize').html(response.recipe.serving_size);
                }
            });
