...
.slide {
  ...
  <body>
    ...
    <div class="showrooms clearfix" id="slider">
			  <?php 
			  ...
			  ?>
				<div class="slide">
				<a class="menu-tab mainmenu" data-id="<?php echo $row1['id'];?>" id="li_<?php echo $row1['id']; ?> v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">
				
				<input type="hidden" id="<?php echo $row1['id']; ?>" class="menuGroup_li_<?php echo $i;?>">
				<?php echo ucfirst($row1['title']); ?></a></div>
			  <?php $i++;}} ?>
			  </div>
			  </div>
