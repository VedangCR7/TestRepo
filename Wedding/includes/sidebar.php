<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-list"></i>Forms</a>
  ...
  if($highlight == "addschool"){
	  ?>
    <li class="active"> <a href="add-school.php"><i class="icon icon-signal"></i> <span>Add Wedding</span></a> </li>
	...
	?>
    <li> <a href="add-school.php"><i class="icon icon-signal"></i> <span>Add Wedding</span></a> </li>
