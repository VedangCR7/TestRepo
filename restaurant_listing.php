            ...
            <div class="row">
                <div class="col-md-offset-2 col-md-8">
                    <div class="page-header text-center">
                        ...
                        <h1 style="margin-top:50px;">YouCloud Restaurants</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 vendor-box">
                    <div class="vendor-image" style="border: 1px solid #e9e6e0;">
                        <a href="restaurants/<?php echo str_replace(" ","-",$vendorCity);?>/<?php echo str_replace(" ","-",$businessName);?>">
                    ...
                    <div class="vendor-detail" style="min-height:160px!important;">
                        <div class="caption" style="padding: 11px;">
                            <h2><a href="restaurants/<?php echo str_replace(" ","-",$vendorCity);?>/<?php echo str_replace(" ","-",$businessName);?>"" class="title"><?=$businessName?></a></h2>
