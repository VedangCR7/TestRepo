                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-12 col-12" style="margin-top:10px;">
                    <label style="font-weight:bold;width:100%;float:left;">In Time</label>
                        <input id="timepkr" style="width:80%;float:left;" class="form-control" placeholder="HH:MM" disabled oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
                        <button type="button" class="btn btn-primary" onclick="showpickers('timepkr',24)" style="width:20%;float:left;"><i class="far fa-clock"></i></button>
                      </div>
...
<script src='<?=base_url();?>assets/js/custom/restaurantwaitinglist.js'></script>
<script type="text/javascript">
