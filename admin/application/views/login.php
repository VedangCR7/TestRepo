...
body {
	...
	<body>
		...
		<div class="page">
			<div class="container">
				<div class="row">
					<!-- <a href="https://api.whatsapp.com/send?phone=+917387135635&text=I'm%20interested%20in%20your%20services" target="_blank">	Click to WhatsApp Chat</a> -->
										...
										<form method="post" action="javascript:;" id="login-form">
											<div class="card-body text-center">
												<div class="text-center mb-6">
													<img src="<?php echo APP_LOGO ?>" class="" alt=""  width="100%;" style="max-width: 40% !important;">
												</div>
												...
												<div class="text-center text-muted mt-3 mb-3 p-10">
													...
													<span style="float: right;">
														Don't have Youcloud account yet? <a href="<?=base_url('onboarding/onboardingone');?>">Sign up</a>
													</span>
												</div>
											</div>
										</form>
		...
		<script type="text/javascript">
		    $(document).ready(function() {
		        ...
		        if(status=="inactive"){
		        	swal("Error !","Your account is inactive now, for support please contact to Youcloud","error");
		        }
				if(status=="delete"){
		        	swal("Error !","Your account is delete now, for support please contact to Youcloud","error");
		        }
		        $("#login-form").validate({
				    rules: {
				        email: {
		...
		<script type="text/javascript" src="<?=base_url();?>assets/js/custom/Login.js?v=8"></script>
		<script type="text/javascript">
