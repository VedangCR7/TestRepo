...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="side-menu__icon fas fa-utensils mr-1"></i>Menu Master</h3>
			<ol class="breadcrumb">
	...
	<div class="row row-div-quantity addnewmanager">
		<div class="col-md-12">
			<form class="form-recipe-edit" method="post" action="javascript:;">
				<div class="row">
					<div class="col-md-1 text-center">
						...
						<a href="<?=base_url_path.'assets/masterMenuExcel.xlsx'?>" download>
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-12">
						<input type="text" name="name" id="name" class="form-control" placeholder="Create Master Menu"style="text-transform: capitalize;">
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-12" id="giveeditbutton">
					<button type="submit" class="btn btn-secondary btn-save-details btn-add-group" type="button" style="background-color: #ED3573;border: 0px !important;">Add</button>
					</div>
				</div>
			</form>
		</div>
	...
	<div class="row mb-3 row-filter" style="margin-top:10px;">
		<div class="col-md-7">
			<div class="input-group">
				<input type="text" class="form-control" placeholder="Search Master Menu"  id="searchInput" style="font-size: 17px;">
...
<script src="<?=base_url();?>assets/js/custom/MasterMenu.js"></script>

<script type="text/javascript">
	MasterMenu.base_url="<?=base_url();?>";
	MasterMenu.init();
