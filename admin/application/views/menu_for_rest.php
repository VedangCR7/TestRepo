...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="side-menu__icon fas fa-utensils mr-1"></i> Menu For Restaurant</h3>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Home</a></li>
				<li class="breadcrumb-item active" aria-current="page">Menu For Restaurant</li>
			</ol>
		</div>
		<!--Page Header-->
	</div>
	<div class="row mb-3 row-filter">
		<div class="col-md-7">
			<div class="input-group">
				...
				<span class="input-group-append btn-search">
					<button class="btn btn-primary" type="button" style="border-radius: 4px;"><i class="fas fa-search"></i></button>
				</span>
					<button class="btn btn-outline-danger btn-clear-filter" type="button" style="border-radius: 4px;"><i class="fas fa-minus-circle"></i> Clear</button>
			</div>
		</div>
		<div class="col-md-2 p-l-5 p-r-5">
			<div class="btn-group per_page m-r-5">
				<button class="btn btn-default dropdown-toggle" data-toggle="dropdown" type="button" aria-expanded="false" selected-per-page="15">
					15 items per page
			...
			<div class="card">
				<div class="card-body">
					<div class="table-responsive">
						<tfoot>
							<button type="button" class="btn btn-info btn-recipe-restaurant" style="text-align: right;float: left;">Add </button>
						</tfoot>
						<table class="table card-table table-vcenter text-nowrap table-head" id="table-recipes">
							<thead >
								<tr>
									<th><input type="checkbox" name="all_recipes" class="input-menu-forall"></th>
...
?>
<script src="<?=base_url();?>assets/js/custom/Recipemenurest.js?v=2"></script>

<script type="text/javascript">
	Recipemenurest.base_url="<?=base_url();?>";
	Recipemenurest.group_id="<?php if(isset($_GET['group_id'])) echo $_GET['group_id']; else echo '';?>";
	Recipemenurest.init();
