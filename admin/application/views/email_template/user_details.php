									...
									<tr>
									 <td style="padding:30px 20px;padding-bottom:0;background:#ffffff;border:#dddddd solid 1px;border-bottom:none">
										<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="font-family:arial;font-size:13px;color:#585455">
											<tbody>
												<tr>
													<td style="padding-bottom:15px"><?=$name;?>, welcome to YouCloud!</td>
												</tr>
												<tr>
													<td style="line-height:20px;padding-bottom:10px">						    
														<p>
															You’re now an official YouCloud and ready to depart on an exciting journey to better management, better service, better performance, better business! We think you're going to love it.
														</p>										
														<p>
															In the next few days expect to receive from us a series of emails full of tips and suggestions for the next best step. Making the most of your account is what matters to us.
														</p>									   
													</td>
												</tr>								
											</tbody>
													...
													<tbody>
														<tr>
															<td style="line-height:20px;padding-bottom:15px;color:#686465">
																<b>Help Center</b>
																<br/>
																Our awesome support team is always here to help through live chat or email at noreply@youcloudresto.com<br>
																<br/>
																<!--<img src="<?php echo APP_LOGO ?>" style="width: 30%;" >-->
																<?php echo APP_NAME ?>		
															</td>
														</tr>
													</tbody>
