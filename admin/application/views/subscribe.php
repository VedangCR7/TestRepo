...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?=base_url();?>client/css/normalize1.css" />
    <link rel="stylesheet" href="<?=base_url();?>client/css/global1.css" />
    <script src="https://js.stripe.com/v3/"></script>
    <script src="<?=base_url();?>assets/js/stripesubscribe.js" defer></script>
  </head>
