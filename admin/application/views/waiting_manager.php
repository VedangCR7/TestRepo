...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="side-menu__icon fe fe-user mr-1"></i>Waitinglist Manager</h3>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Home</a></li>
				<li class="breadcrumb-item active" aria-current="page">Waitinglist Manager</li>
			</ol>
		</div>
		<!--Page Header-->
	</div>
							...
							<form class="form-recipe-edit" method="post" action="javascript:;">
								<div class="row">
									...
									<div class="col-lg-3 col-md-3 col-sm-12 col-12" style="margin-top:10px;">
										...
										<input type="text" name="name" id="name" class="form-control" placeholder="Enter Name" onChange="chkNameVal()" style="text-transform: capitalize;">
									</div>
									<div class="col-lg-3 col-md-3 col-sm-12 col-12" style="margin-top:10px;">
	...
	<div class="row mb-3 row-filter">
		...
		<div class="col-md-5">
			<div class="input-group">
				<input type="text" class="form-control" placeholder="Search Waitinglist Manager"  id="searchInput" style="font-size: 17px;">
...
<script src="<?=base_url();?>assets/js/custom/Waitingmanager.js?v=2"></script>
...
<script type="text/javascript">
	Waitingmanager.base_url="<?=base_url();?>";
	Waitingmanager.init();
