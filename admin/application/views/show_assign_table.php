...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="side-menu__icon fe fe-shuffle mr-1"></i>Assign Tables</h3>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Home</a></li>
				<li class="breadcrumb-item active" aria-current="page">Assign Tables</li>
			</ol>
		</div>
		<!--Page Header-->
	</div>
	...
	<div class="row mb-3 row-filter">
		...
		<div class="col-md-5">
			<div class="input-group">
				<input type="text" class="form-control" placeholder="Search By User Name"  id="searchInput" style="font-size: 17px;">
				...
				<div class="card-body">
					<div class="table-responsive">
						<table class="table card-table table-vcenter text-nowrap table-head" id="table-recipes">
							...
							<tbody class="tbody-group-list" id="tbody-group-list">
							</tbody>
						</table>
					</div>
				</div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
	  ...
	  <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="assign_table">Save Changes</button>
		<button type="button" class="btn btn-primary" id="assign_table1" style="display:none;">Save Changes</button>
      </div>
...
<script src="<?=base_url();?>assets/js/custom/Userassigntable.js?v=<?php echo uniqid();?>"></script>

<script type="text/javascript">
	Userassigntable.base_url="<?=base_url();?>";
	Userassigntable.init();
