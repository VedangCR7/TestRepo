	...
	<aside class="app-sidebar">
		...
		<ul class="side-menu">
			<?php
				...
				?>
				<li>
					<a class="side-menu__item" href="<?=base_url()?>admin/"><i class="side-menu__icon si si-screen-desktop"></i><span class="side-menu__label">Order Dashboard</span></a>
				</li>
				<!--<li>
				...
				<li>
					<a class="side-menu__item" href="<?=base_url()?>admin/all_restaurants"><i class="side-menu__icon si si-screen-desktop"></i><span class="side-menu__label">Account</span></a>
				</li>
					<li>
					<a class="side-menu__item" href="<?=base_url()?>admin/all_restaurants1"><i class="side-menu__icon si si-screen-desktop"></i><span class="side-menu__label">Onboarding</span></a>
				</li>
					<li>
					<a class="side-menu__item" href="<?=base_url()?>admin/all_Cuisines"><i class="side-menu__icon si si-screen-desktop"></i><span class="side-menu__label"</span> Cuisines</a>
				</li>
				<li>
					<a class="side-menu__item" href="#"><i class="side-menu__icon si si-screen-desktop"></i><span class="side-menu__label"</span> Reports</a>
				</li>
				<!--<li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<?php if (in_array('Restaurant Manager',$restaurant_sidebar)) {  ?>
						 	<li><a class="slide-item" href="<?=base_url()?>Restaurant_manager/restaurant_list_manager">Captain</a></li>
							...
							<li><a class="slide-item" href="<?=base_url()?>Delivery">Delivery Boy</a></li>
							<li><a class="slide-item" href="<?=base_url()?>kitchen_staff/kitchen_staff_list">Kitchen Staff</a></li>
							<li><a class="slide-item" href="<?=base_url()?>helper/helper_list">Helper</a></li>
							<li><a class="slide-item" href="<?=base_url()?>head_chef/head_chef">Head Chef</a></li>
							<li><a class="slide-item" href="<?=base_url()?>assistant_chef/assistant_chef">Assistant Chef</a></li>
							<li><a class="slide-item" href="<?=base_url()?>utility/utility">Utility</a></li>
						</ul>
					</li>
				...
				<?php } if (in_array('Waitinglist',$restaurant_sidebar)) { ?>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="<?=base_url()?>Waiting_manager/restaurant_waiting_dashboard">WaitingList Dashboard</a></li>
				...
				<?php } if (in_array('Incentive',$restaurant_sidebar)) { ?>
					<li class="slide">
						...
						<ul class="slide-menu">
							 ...
							 <li><a class="slide-item" href="<?=base_url()?>Calculate_incentive_report/index">Employee Incentive Report</a></li>
				...
				<?php } 
					if (in_array('Inventory Management',$restaurant_sidebar)) { ?>
					...
					<?php } if (in_array('Inventory Report',$restaurant_sidebar)) { ?>
					<li class="slide">
