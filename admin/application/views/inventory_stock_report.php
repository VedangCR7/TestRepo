...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="fe fe-home mr-1"></i> Stock List Report</h3>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Home</a></li>
				<li class="breadcrumb-item active" aria-current="page">Stock List Report</li>
			</ol>
		</div>
						...
						<table class="datatable-withbuttons table table-striped dt-responsive nowrap" id="table-orders">
							...
							<tbody class="tbody-order-list">
								...
								<tr>
									...
									<td><?=$order['pur_qty'];?></td>
									<td><?php if($order['assign_quantity']==0){ echo $order['pur_qty']; } else{?><?=$order['remaining_quantity'];?><?php } ?></td>
