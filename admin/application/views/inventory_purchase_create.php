...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="side-menu__icon fe fe-dollar-sign mr-1"></i>Purchase Create</h3>
			<ol class="breadcrumb">
				...
				<div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-sm-12 col-sm-12 col-12 table-responsive" style="margin-top:20px;">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>Product Name</th>
                                        <th style="width:15%">Qty (KG /LTR)</th>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-right">
                            <button class="btn btn-primary btn-add-purchase">Confirm Purchase</button>
                        </div>
                    </div>
				</div>
			</div>
...
<script src="<?=base_url();?>assets/js/custom/Inventorypurchasecreate.js?v=10"></script>

<script type="text/javascript">
	Inventorypurchasecreate.base_url="<?=base_url();?>";
	Inventorypurchasecreate.init();
