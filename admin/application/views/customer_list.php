...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="side-menu__icon fe fe-users mr-1"></i> Customers</h3>
			<ol class="breadcrumb">
...
?>
<script src="<?=base_url();?>assets/js/custom/Customerlist.js?v=2"></script>
...
<script type="text/javascript">
	Customerlist.base_url="<?=base_url();?>";
	Customerlist.init();
