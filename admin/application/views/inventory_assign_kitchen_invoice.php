...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="fe fe-home mr-1"></i>Assign to Kitchen Invoice Details</h3>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Home</a></li>
				<li class="breadcrumb-item active" aria-current="page">Assign to Kitchen Invoice Details</li>
			</ol>
		</div>
			...
			<div class="card">
                <div class="card-header">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-right">
                        ...
                        <a href="<?=base_url('inventory/edit_assign_kitchen_invoice/'.$this->uri->segment(3))?>"><button class="btn btn-warning"><i class="fas fa-edit"></i> Edit Invoice</button></a>
                    </div>
                </div>
				<div class="card-body printableArea" id="printableArea">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center"><h4>Assign to kitchen Invoice</h4></div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:-20px;"><hr></div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                        <p>Invoice No : <?=$assign_kitchen_details[0]['invoice_no']?></p>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                        <p>Invoice Date : <?=$assign_kitchen_details[0]['created_at']?></p>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                        <p>Supplier Name : <?=$assign_kitchen_details[0]['company_name']?></p>
                    </div>
					<div class="table-responsive mt-4 table-single-orders">
						<table class="table table-bordered">
							...
							<tbody class="tbody-order-list">
								...
								$i=1;
                                $sub_total=0;
								foreach ($assign_kitchen_details as $item) {
								?>
								<tr>
									<td><?=$i++?></td>
								...
								<?php
                                $sub_total= $sub_total+$item['assign_quantity'];
								}
								?>
							</tbody>
                            <tfoot>
