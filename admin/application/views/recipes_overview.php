...
?>
<script src="<?=base_url();?>assets/js/custom/Recipeadmin.js"></script>

<script type="text/javascript">
	Recipeadmin.base_url="<?=base_url();?>";
	Recipeadmin.group_id="<?php if(isset($_GET['group_id'])) echo $_GET['group_id']; else echo '';?>";
	Recipeadmin.init();
