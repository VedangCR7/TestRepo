				...
				<div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-12" style="margin-top:10px;">
                            ...
                            <input type="text" class="form-control" placeholder="Contact Person Name" id="contact_person_name" style="text-transform: capitalize;" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)">
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-12 col-12" style="margin-top:10px;">
                            <label style="font-weight:bold">Mobile</label>
                            <input type="text" class="form-control" placeholder="Mobile" id="mobile" onkeypress="return isNumber(event)">
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-12 col-12" style="margin-top:10px;">
