            ...
            <div class="col-lg-12 vh-100 div-select-menu" style="display: none;">
                ...
                <div class="promo-wrap promo-2">
					...
					if(count($menu_groups)>0)
					{
						...
						{
							if($tableid!="")
								$url=base_url().'menus/'.$group['main_menu_id'].'/'.$restid.'/'.$tableid.'?recipetype='.$recipe_type.'&list_view=yes&is_website='.$is_website;
							else
								$url=base_url().'menus/'.$group['main_menu_id'].'/'.$restid.'?recipetype='.$recipe_type.'&list_view=yes&is_website='.$is_website;
					?>
