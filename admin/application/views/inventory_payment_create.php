	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-12 text-right"><a href="<?=base_url('inventory/payment_list')?>"><button class="btn btn-primary"><i class="fas fa-list-ol"></i> Payment List</button></a></div>
					</div>
                    <div class="row">
