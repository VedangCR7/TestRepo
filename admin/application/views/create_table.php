...
<div class=" app-content">
	...
	<div class="row">
		<div class="col-md-6 mb-3">
			<div class="input-group">
				<input type="text" class="form-control" placeholder="Create table" id="AddMenuGroup" style="font-size: 15px;">
				<input type="hidden" id="menu_group_id">
				<input type="hidden" id="is_edit_group">
				<select name="main_menu_id" class="form-control select-main-menu" placeholder="Select table category">
	...
	<div class="row mb-3 row-filter">
		<div class="col-md-7">
			<div class="input-group">
				<input type="text" class="form-control" placeholder="Search table"  id="searchInput" style="font-size: 17px;">
				<span class="input-group-append">
				...
				<div class="card-body">
					<div class="table-responsive">
						<table class="table card-table table-vcenter text-nowrap table-head" id="table-recipes">
							<thead >
								<tr>
									<th style="width: 37%;">Table Category</th>
									<th>Title</th>
									<th>Date</th>
									<th>QR Code</th>
