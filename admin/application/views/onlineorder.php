			...
			<div class="col-md-12 col-xl-12 mt-3">
				<div class="card">
					...
					<div class="row">
							...
							<?php if($show_table_title[0]['flag'] !=1){ ?>
								<p style="font-weight:bold;" class="text-primary">Table No : <?=$show_table_title[0]['title']?></p>
							<?php } ?>
								<p style="font-weight:bold;" class="text-primary" style="display:none;" id="show_payment_status"></p>
							</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-12 show_date"></div>
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:10px;">
							                        	...
							                        	<div class="col-md-3">
								                           ...
								                           <div class="form-group">
								                              <label for="">Select Item</label>
																...
																<input type="hidden" name="invoice_id" class="input-invoice-id" id="input-invoice-id" value="<?=$invoice_id;?>">
								                          </div>
							                        	</div>
							                        	<div class="col-md-1">
										                    <div class="form-group">
															...
															<tbody class="total-section">
																...
																<tr>
																	<td class="text-right td-totaldetails">
																		<span id="delivery_html" class="delivery_html">Delivery <?=$currency_symbol[0]['currency_symbol'];?></span>
																		<input type="hidden" name="" id="sub_total"  class="sub_total">
																	</td>
																</tr>
																<tr>											
												...
												<div class="col-lg-12 pb-2 col-md-12 col-sm-12 col-12 text-right">
													...
													<button type="button" class="btn btn-success" id="deliverer"  data-toggle="modal" data-target="#delivery">Assign deliverer</button>
...
<!-- code addev By victor -->
<div class="modal fade" id="delivery" tabindex="-1" role="dialog" aria-labelledby="delivery" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="deliveryModalLabel">Active Deliverers </h5>
			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			<span aria-hidden="true">&times;</span>
			</button>
		</div>
	  	<div class="alert alert-primary my-3 mx-5" id="modal_message" role="alert" hidden>
			This is a primary alert—check it out!
		</div>
      <div class="modal-body" id="deliverer_list">
