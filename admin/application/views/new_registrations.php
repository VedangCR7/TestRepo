...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="fe fe-user mr-1"></i> New Registrations</h3>
			<ol class="breadcrumb">
...
<script src="<?=base_url();?>assets/js/custom/Newregistration.js?v=2"></script>

<script type="text/javascript">
	Newregistration.base_url="<?=base_url();?>";
