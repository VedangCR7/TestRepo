						...
						<div class="container">
							<div class="row" style="margin-top:50px;">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:20px;text-align:center;">
									<p><b>Create Your Youresto Account</b></p>
								</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:20px;">
									<select class="form-control select2-show-search" name="countrycode" id="countrycode" selected-value="" required>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:20px;">
									<select class="form-control" name="restauranttype" id="restauranttype">
										...
										<option value="both">Veg/NonVeg</option>
										<option value="vegan">Vegan</option>
										<option value="keto diet">Keto diet</option>
									</select>
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:20px;">
									<input type="text" class="form-control" placeholder="Mobile No Ex 710XXXXXX " onkeypress="return isNumber(event);" id="contact_number">
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:20px;">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:20px;">
									<h6 class="text-warning">Get OTP</h6>
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:20px;">
									<input type="text" class="form-control" placeholder="Enter OTP Number">
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:20px">
									<p>Enter the OTP number received. <b class="text-primary">Resend OTP</b></p>
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:20px;">
									<input type="checkbox" class="terms_condition_check" name="terms_condition_check">&nbsp;&nbsp;I Agree The Terms And Conditions..
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:20px;">
									<button class="btn btn-primary form-control" style="background-color:#1B949D;" id="register">Register Now!</button>
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:20px;text-align:center;">
									<p>Already Register <a href="<?=base_url('onboarding/login')?>">Login</a>?Copyright © YouResto 2021</p>
								</div>
							</div>
						</div>
					</div>
...
return true;
	...
	<script>
		$('#register').click(function(){
			if($('input[name=terms_condition_check]:checked').val() != 'on'){
			...
			if($('#contact_number').val().length>14 || $('#contact_number').val().length<8){
				swal("Error!", "Contact Number should have 8 to 14 digit in length!", "error");
				return false;
			}
			...
			if($('#confirm_password').val()==''){
				swal("Error!", "Confirm password is required!", "error");
				return false;
			}
			if($('#confirm_password').val() != $('#password').val()){
				swal("Error!", "Password & Confirm password not match!", "error");
				return false;
			}
			if($('#countrycode').val() == ''){
				swal("Error!", "Country code is required", "error");
				return false;
			}
			$.ajax({
				url: "<?=base_url()?>onboarding/register",
				type:'POST',
				data:{name:$('#name').val(),countrycode:$('#countrycode').val(),contact_number:$('#contact_number').val(),email:$('#email').val(),password:$('#password').val(),restauranttype:$('#restauranttype').val()},
				success: function(result){
					if(result.status){
						swal(result.msg)
						.then((value) => {
						  window.location.href="<?=base_url('onboarding/onboardingstepone/')?>"+result.last_id;
						});
					}else{
