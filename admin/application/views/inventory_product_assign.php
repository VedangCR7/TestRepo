...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="side-menu__icon fas fa-utensils mr-1"></i>Product Assign to kitchen</h3>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Home</a></li>
				<li class="breadcrumb-item active" aria-current="page">Product Assign to kitchen</li>
			</ol>
		</div>
		<!--Page Header-->
	</div>
                        ...
                        <div class="col-lg-12 col-sm-12 col-sm-12 col-12 table-responsive" style="margin-top:20px;">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>Product Name</th>
                                        <th>Available Qty (KG /LTR)</th>
                                        <th>Assign Qty (KG /LTR)</th>
                                        <th>Remaining Qty (KG /LTR)</th>
                                    </tr>
                                </thead>
...
<script src="<?=base_url();?>assets/js/custom/Inventoryproductassign.js?v=<?=uniqid()?>"></script>
