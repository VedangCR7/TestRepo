...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="side-menu__icon fe fe-user mr-1"></i>Helper</h3>
			<ol class="breadcrumb">
	...
	<div class="row mb-3 row-filter">
		...
		<div class="col-md-5">
			<div class="input-group">
				<input type="text" class="form-control" placeholder="Search Helper"  id="searchInput" style="font-size: 17px;">
...
<script src="<?=base_url();?>assets/js/custom/Helper.js?v=<?php echo uniqid();?>"></script>
