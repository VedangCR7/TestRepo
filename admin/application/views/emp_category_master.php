...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="side-menu__icon fas fa-utensils mr-1"></i> Category Master</h3>
			<ol class="breadcrumb">
	...
	<div class="row row-filter mb-3">
		...
		<div class="col-md">
			<div class="input-group">
				<input type="text" class="form-control catname" placeholder="Create category *" id="Categoryname" style="font-size: 15px;">
				<span class="input-group-append updclass">
					<button class="btn btn-secondary btn-add-category" type="button" style="border-radius: 4px;border: 0px !important;">ADD</button>
				</span>
			</div>
		</div>		
		<div class="col-md">
			<div class="input-group">
				<input type="text" class="form-control" placeholder="Search Category"  id="searchInput" style="font-size: 17px;">
			...
			<div class="card">
				<div class="card-body">
					<div class="table-responsive">
						<table class="table card-table table-vcenter text-nowrap table-head" id="table-category">
							<thead >
								<tr>
									<!-- <th></th>									 -->
									<th>Main Category</th>
...
<script src="<?=base_url();?>assets/js/custom/CategoryDetails.js?v=2"></script>

<script type="text/javascript">
	CategoryDetails.base_url="<?=base_url();?>";
