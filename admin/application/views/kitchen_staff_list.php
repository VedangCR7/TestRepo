...
<div class=" app-content">
	<div class="side-app">
		...
		<div class="page-header">
			<h3 class="page-title"><i class="side-menu__icon fe fe-user mr-1"></i>Kitchen Staff</h3>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Home</a></li>
				<li class="breadcrumb-item active" aria-current="page">Kitchen Staff</li>
			</ol>
		</div>
		<!--Page Header-->
	</div>
							...
							<form class="form-recipe-edit" method="post" action="javascript:;">
								...
								<div class="row">
									...
									<div class="col-lg-3 col-md-3 col-sm-12 col-12" style="margin-top:10px;">
										...
										<input type="text" name="name" id="name"  class="form-control" placeholder="Enter Name" onkeydown="return alphaOnly(event);">
									</div>
									<div class="col-lg-3 col-md-3 col-sm-12 col-12" style="margin-top:10px;">
	...
	<div class="row mb-3 row-filter">
		...
		<div class="col-md-5">
			<div class="input-group">
				<input type="text" class="form-control" placeholder="Search Kitchen Staff"  id="searchInput" style="font-size: 17px;">
...
<script src="<?=base_url();?>assets/js/custom/Kitchecnstaff.js?v=<?php echo uniqid();?>"></script>
