        ...
        if($query->num_rows()){
			...
			{				
                $userdata = array(
                   ...
                   'currency_symbol'=>$result['currency_sumbol']
                ); 
