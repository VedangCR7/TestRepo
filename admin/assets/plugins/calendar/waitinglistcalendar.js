                            ...
                            "<div class='panel-group' id='accordion-<%=d %>' role='tablist' aria-multiselectable='true'>"+
                             "<% var events = days[d].events; for(var s = 0; s < events.length;s++){ %>"+
                                "<div class='panel panel-default mt-2'>"+
                                    "<div class='panel-heading ' role='tab' id='headingOne<%= events[s].calendar_date %>-<%=s%>'>"+
                                        "<h4 class='panel-title text-center'>"+
                                            "<a role='button' data-toggle='collapse' data-parent='#accordion-<%=d %>' href='#collapseOne-<%= events[s].calendar_date %>-<%=s%>' aria-expanded='true' aria-controls='collapseOne-<%= events[s].calendar_date %>-<%=s%>'>"+
                                                 "<%= events[s].name %>"+
                                            "</a>"+
                                        "</h4>"+
                                    "</div>"+
