var Allrestaurants ={
				...
				var html = '<div class="col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top:10px;">';
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top:10px;">';
      					...
      					<div class="col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top:10px;">';
      						...
      						html+='<input type="checkbox" data-id="Billing" name="menu[]" value="Billing" class="menu" checked> Counter';}
      						else {
      						html+='<input type="checkbox" data-id="Billing" name="menu[]" value="Billing" class="menu"> Counter';}
      					html +='</div>\
      					<div class="col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top:10px;">';
      					...
      					<div class="col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top:10px;">';
      						...
      						html+='<input type="checkbox" data-id="Restaurant Manager" name="menu[]" checked value="Restaurant Manager" class="menu"> Captain';}
      						else {
      						html+='<input type="checkbox" data-id="Restaurant Manager" name="menu[]" value="Restaurant Manager" class="menu"> Captain';}
      					html +='</div>\
      					<div class="col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top:10px;">';
    ...
    //         	}
				...
				$('#showcheckbox').html('<div class="col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top:10px;">\
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top:10px;">\
      					...
      					<div class="col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top:10px;">\
      						<input type="checkbox" data-id="Billing" name="menu[]" value="Billing" class="menu" checked> Counter\
      					</div>\
      					<div class="col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top:10px;">\
      					...
      					<div class="col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top:10px;">\
      						<input type="checkbox" data-id="Restaurant Manager" name="menu[]" value="Restaurant Manager" class="menu" checked> Captain\
      					</div>\
      					<div class="col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top:10px;">\
    ...
    listmanager:function(data,fromevent){
        console.log(data);
        $.ajax({
            url: Allrestaurants.base_url+"Admin/list_restaurants1/",
            type:'POST',
            dataType: 'json',
            data: data,
