var Restoffer ={
    ...
    bind_events :function() {
		...
		$('input[name=discount_type]').change(function(){
			if($(this).val() == 'Flat'){
				$('#discount').attr('placeholder','Enter Discount in Amount');
			}else{
				$('#discount').attr('placeholder','Enter Discount in Percentage');
			}
		});
            ...
            <div class="card welcome-image">\
                <div class="card-body">\
                    <div class="row">\
                            ...
                            <form class="form-recipe-edit" method="post" action="javascript:;">\
                                <div class="row">\
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12" style="margin-top:10px;">\
                                        ...
                                        <input type="text" value="'+result['offer'].title+'" name="title" id="edittitle" class="form-control" placeholder="Offer Title" style="text-transform: capitalize;">\
                                    </div>\
									<div class="col-lg-4 col-md-4 col-sm-12 col-12" style="margin-top:10px;">\
										<label style="font-weight:bold;">Discount Type</label><br>';
										if(result['offer'].discount_type == 'Flat'){
										html+='<input type="radio" name="edit_discount_type" value="Flat" checked>&nbsp;Flat\
										<input type="radio" name="edit_discount_type" value="Percentage">&nbsp;Percentage';
										}else{
										html+='<input type="radio" name="edit_discount_type" value="Flat">&nbsp;Flat\
										<input type="radio" name="edit_discount_type" value="Percentage" checked>&nbsp;Percentage';
										}
									html+='</div>\
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12" style="margin-top:10px;">\
						...
						<input type="date" id="edit_start_date" class="form-control" value="'+result['offer'].start_date+'" min="'+$('#current_date_filter').val()+'">\
					</div>\
					<div class="col-lg-4 col-md-4 col-sm-12 col-12">\
						<label style="font-weight:bold;margin-top:10px;">End Date</label>\
						<input type="date" id="edit_end_date" class="form-control" value="'+result['offer'].end_date+'" min="'+$('#current_date_filter').val()+'">\
					</div>\
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12" style="margin-top:10px;">\
	...
	if ($('#edit_end_date').val()=='') { Restoffer.displaywarning("Offer end date is Required");return false;}
		...
		discount_type:$('input[name=edit_discount_type]:checked').val()
            } 
            $.ajax({
