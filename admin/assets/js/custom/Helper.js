var Waiter ={
    ...
    assign_table_to_manager:function(){
        ...
        console.log(array);
        $.ajax({
            url: Waiter.base_url+"helper/assign_table_to_manager",
            type:'POST',
    ...
    onassigntable:function(){
        ...
        $.ajax({
            url: Waiter.base_url+"helper/show_table_rest_manager",
            type:'POST',
                        ...
                        swal({
                            ...
                            if(swalinput){
                               ...
                               /* self.closest('td').find('.img-upload').attr('data-image-src',imageData);
                                ...
                                $.ajax({
                                    url: Waiter.base_url+"helper/update_profile_photo",
                                    type:'POST',
                                    data: $form_data,
                                    processData:false,
                                    contentType:false,
    ...
    changeStatusManager:function(){
        ...
        $.ajax({
            url: Waiter.base_url+"helper/delete_manager",
            type:'POST',
            data:formData ,
            success: function(result){
               if (result.status) {
    ...
    onDeleteManager:function(){
        ...
        swal({
            ...
            $.ajax({
                url: Waiter.base_url+"helper/delete_perticular_restaurant_manager",
                type:'POST',
                data:formData ,
                success: function(result){
                   if (result.status) {
    ...
    onSaveGroupname:function(){
        ...
        if($('#name').val()!="" && $('#email').val()!="" && $('#contact_number').val()!=""){
            ...
            if ($('#profile_photo').val() != '') {
                $('#image-loader').show();
                $.ajax({
                    url: Waiter.base_url+"helper/add_profile_photo",
                    type:'POST',
                    dataType: 'json',
                    data: {
                        name : $('#name').val(),
                ...
                $('#image-loader').show();
                $.ajax({
                    url: Waiter.base_url+"helper/save_restaurant_manager",
                    type:'POST',
                    dataType: 'json',
                    data: {
                        name : $('#name').val(),
    ...
    listmanager:function(data,fromevent){
        $.ajax({
            url: Waiter.base_url+"helper/list_manager/",
            type:'POST',
            dataType: 'json',
            data: data,
