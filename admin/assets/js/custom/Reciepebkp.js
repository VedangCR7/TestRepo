var Reciepe ={
    ...
    bind_events :function() {
       ...
       /* $('.div-ingredient-result').on('mouseover','.lv-item',function(){
        ...
        $('.btn-add-group').on('click',this.onAddGroupName);
    ...
    {    
        ...
        for (k in ingredient_items) {
            ...
            console.log(percentage,ext_qty);
            var html='<li class="border-bottom-0 p-2">\
                    <div class="row">\
                        ...
                        <div class="col-md-2">\
                            '+ext_qty+''+ingredient_items[k].quantity_unit.desc+'\
                        </div>\
                        <div class="col-md-8">\
            ...
            if(str=="")
                str=ingredient_items[k].ingredient.declaration_name;
            else
                str=", "+ingredient_items[k].ingredient.declaration_name;
            var allergens_str="";
			var allergens_str1="";
            var in_allergens=ingredient_items[k].ingredient.allergens;
            ...
            if(allergens_str!="")
                ...
                $('.p-allergens-li').append(str);
                 ...
                 if(allergens_str1!="")
                $('.p-allergens-li').append('<ul><li><b style="font-weight: 800;">'+allergens_str1+'</b></li>');
            else
                $('.p-allergens-li').append('</ul>');
            }
