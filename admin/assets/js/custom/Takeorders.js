var Takeorders ={
	...
	bind_events :function() {
		var self=this;
		$('body').on('click','.cancel_discount_note',function(){
			$('.discount_note_add').val('');
			 var tab_pane=$(this).closest('.tab-pane');
			tab_pane.find('#discountnotemodal').modal('hide');
		});
        ...
        //$('.btn-add-item').on('click',this.addneworder);
		...
		if($('#cancel_note').val() == ""){
			Takeorders.displaywarning('Please Enter Cancel Note');
            		return false;
		}
            $.ajax({
                url: Takeorders.base_url+"restaurant/change_order_status/",
                type:'POST',
                dataType: 'json',
		...
		$('.tab-content').on('change',".enter_payment",this.onChangepayment);
    ...
    onChangeCGST:function()
	{
        ...
        tab_pane.find('.nettotal_html').html('Net Total '+Takeorders.currency_symbol+" "+net_total.toFixed('2'));
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:10px;">\
                    <div class="row pb-2 mb-2" style="border-bottom: 1px solid #ddd;">\
                        <div class="col-lg-4 col-md-12   col-sm-12 col-12">\
                            ...
                            <input type="text" minlength="8" maxlength="14" name="mobile_no" class="mobile_no form-control" placeholder="Customer Contact number" id="mobile_no'+bill_count+'" oninput="this.value = this.value.replace(/[^0-9.]/g, "").replace(/(\..*)\./g, "$1");" onkeypress="return Takeorders.isNumber(event)" value="'+$('#mobile_no').val()+'">\
                        </div>\
                        <div class="col-lg-5 col-md-12 col-sm-12 col-12">\
                            <label>Name</label>\
                            <input type="text" name="customer_name" class="form-control customer_name" placeholder="Customer Name" id="customer_name'+bill_count+'" value="'+$('#customer_name').val()+'" style="text-transform: capitalize;">\
                        </div>\
						<div class="col-lg-2 col-md-12 col-sm-12 col-12">\
							<label>No Of Person</label>\
							<input type="text" name="number_of_person" class="form-control number_of_person" placeholder="No Of Person" id="number_of_person'+bill_count+'" maxlength="2" oninput="this.value = this.value.replace(/[^0-9.]/g, "").replace(/(\..*)\./g, "$1");" onkeypress="return Takeorders.isNumber(event)"">\
						</div>\
                    ...
                    <div class="row select-item-row">\
                        <div class="col-md-12">\
                            <div class="col-md-3">\
                               ...
                               <div class="form-group">\
                                  <label for="">Select Item</label>\
                                    ...
                                    <input type="hidden" name="recipe_grp_id" class="input-item-grp-id" id="input-item-grp-id'+bill_count+'" value="">\
                                    <input type="hidden" name="prd_id" class="input-item-product-code" id="input-item-product-code'+bill_count+'" value="">\
                            ...
                            <div class="col-md-3">\
                                 <button type="button" class="btn btn-secondary btn-addon-item" id="btn-addon-item'+bill_count+'" style="margin-top:22px;display:none;"> Addon Menu</button>\
                                <button type="button" class="btn btn-success btn-add-item" id="btn-add-item'+bill_count+'" style="margin-top:22px;"> Add</button>\
                            </div>\
                        </div>\
                    </div>\
                    <div class="row">\
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 table-responsive">\
                            <table class="table table-bordered border-top billing_total" width="100%" style="font-weight:bold;">\
                                <tbody class="total-section">\
                                        <tr>\
                                            <td class="text-right">\
                                                <span id="subtotal_html'+bill_count+'" class="subtotal_html">Sub Total : '+Takeorders.currency_symbol+'</span>\
                                                <input type="hidden" name="" id="sub_total'+bill_count+'"  class="sub_total">\
                                            </td>\
                                        </tr>\
                                        <tr>\
                                            <td class="text-right">\
                                                <span id="distotal_html'+bill_count+'" class="distotal_html">Discount:  '+Takeorders.currency_symbol+' 0</span>\
                                                <input type="hidden" name="" id="dis_totaldetail'+bill_count+'"  class="dis_totaldetail" >\
                                            </td>\
                                        </tr>\
										<tr>\
                                            <td class="text-right">\
                                                <span id="distotal_percentage_html'+bill_count+'" class="distotal_percentage_html">Discount (%):  '+Takeorders.currency_symbol+' 0</span>\
                                                <input type="hidden" name="" id="dis_percentage_totaldetail'+bill_count+'"  class="dis_percentage_totaldetail" >\
                                            </td>\
                                        </tr>\
                                        <tr>\
                                            <td class="text-right">\
                                                <span id="nettotal_html'+bill_count+'" class="nettotal_html">Net Total '+Takeorders.currency_symbol+'</span>\
                                ...
                                <tbody class="payment-section" style="display: none;">\
                                    ...
                                    <tr>\
                                        <td class="text-right td-totaldetails">\
                                            <span id="bill_discount'+bill_count+'" class="bill_discount">Discount ('+Takeorders.currency_symbol+'):</span>\
                                            <input type="text" name="" id="dis_total'+bill_count+'"  class="dis_total">\
                                        </td>\
                                        <td class="text-right td-payment">\
                                            <span id="cash_html'+bill_count+'" class="cash_html">Cash : </span>\
                                            <input type="text" name="" id="cash_payment'+bill_count+'"  class="cash_payment enter_payment">\
                                        </td>\
                                    </tr>\
                                    <tr>\
                                        <td class="text-right td-totaldetails">\
                                        ...
                                        <td class="text-right td-payment">\
                                            ...
                                            <input type="text" name="" id="card_payment'+bill_count+'"  class="card_payment enter_payment">\
                                        </td>\
                                    </tr>\
                                    <tr>\
                                        <td class="text-right td-totaldetails">\
                                        ...
                                        <td class="text-right td-payment">\
                                            ...
                                            <input type="text" name="" id="upi_payment'+bill_count+'"  class="upi_payment enter_payment">\
                                        </td>\
                                    </tr>\
                                    <tr>\
                                        <td class="text-right td-totaldetails">\
                                        ...
                                        <td class="text-right td-payment">\
                                            ...
                                            <input type="text" name="" id="net_banking'+bill_count+'"  class="net_banking enter_payment">\
                                        </td>\
                                    </tr>\
                                    <tr>\
                                        <td class="text-right td-totaldetails">\
											<span id="nettotal_html'+bill_count+'" class="nettotal_html">Grant Total '+Takeorders.currency_symbol+'</span>\
                                            <input type="hidden" class="net_total" name="" id="net_total'+bill_count+'">\
                                        </td>\
                                    </tr>\
                                </tbody>\
            ...
            $.get(Takeorders.base_url+"restaurant/list_recipes/"+tablecategory, function(data){
                $input.typeahead({ 
                    ...
                    afterSelect:function(item){
						debugger;	
                        $.ajax({
                            url: Takeorders.base_url+"restaurant/check_recipe_addon/",
                            type:'POST',
                            dataType: 'json',
                            data: {
                                recipe_id : item.id,
                            ...
                            success: function(result){
                                ...
                                if(result.status){
                                    tab_pane.find('.btn-addon-item').show();
                                }else{
                                    tab_pane.find('.btn-addon-item').hide();
                                }
                            }
                        });
                        ...
                        tab_pane.find('.input-item-grp-id').val(item.group_id);
                        tab_pane.find('.input-item-product-code').val(item.product_code);
    ...
    addonpopup:function(){
        ...
        var grp_id = tab_pane.find('.input-item-grp-id').val();
        $.ajax({
            url: Takeorders.base_url+"restaurant/show_recipe_addon/",
            type:'POST',
            dataType: 'json',
            data: {
                recipe_id : recipe_id,
    ...
    getCart:function()
	{
        ...
        $.ajax({
            ...
            success: function(result)
			{
				...
				{
                    tab_pane.find('.subtotal_html').html('Sub Total : '+Takeorders.currency_symbol + 0);
                    tab_pane.find('.nettotal_html').html('Net Total : '+Takeorders.currency_symbol + 0);
                    tab_pane.find('.net_total').val('0');
                    tab_pane.find('.sub_total').val('0');
                    tab_pane.find('.distotal_html').html('Discount Total : '+Takeorders.currency_symbol + 0);
    ...
    onSubmitOrder:function()
	{
		...
		if(tab_pane.find('.dis_total').val()==""){
            ...
            var discount=parseFloat(tab_pane.find('.dis_total').val());
			var dp = (parseInt(discount)/parseInt(sub_total))*100;
		}
         console.log(discount);
		...
		if(parseInt(discount_percentage)!=0){
			if(parseInt(discount_percentage) > 39)
			{
		...
		else
		{
            ...
            var data={
                ...
                dis_total:tab_pane.find('.dis_total').val(),
                dis_total_percentage:tab_pane.find('.dis_total_percentage').val(),
				discount_note:tab_pane.find('.discount_note_enter').val(),
                cgst_per:tab_pane.find('.cgst_per').val(),
                sgst_per:tab_pane.find('.sgst_per').val(),
                cash_payment:tab_pane.find('.cash_payment').val(),
                card_payment:tab_pane.find('.card_payment').val(),
    ...
    clearItemForm:function(tab_pan){
        ...
        tab_pan.find(".input-item-product-code").val("");
	...
	addneworder:function()
	{
		...
		var product_code = tab_pan.find('.input-item-product-code').val();
		...
		if(order_id)
		{
            $.ajax({
                ...
                success: function(response){
                    $('#image-loader').show();
                    if(response.status){
                        $('.addon_menu_id').prop('checked',false);
                        tab_pan.find('#addonmodal').modal('hide');
                        $('#image-loader').hide();
                        ...
                        $('.option_name').prop('cchecked',false);
						//location.reload();
                    }
                    else{
                        if (response.msg) {
		...
		else
		{
            ...
            var data={
                ...
                addondata:addon_data.toString(),
                addonprice:addonprice_data.toString(),
                addon_id:addon_ids.toString(),
                addon_main_category:addon_main_categorys.toString(),
                //addon_main_category_id:addon_main_category_id
            }
    		$.ajax({
                ...
                success: function(result){
                   ...
                   /* if (result['sessionarray'].length <=0) {
                    ...
                    $('input[class="option_name"]').prop('checked',false);
                    tab_pan.find('#addonmodal').modal('hide');
        ...
        for (i in cart_details) {
            html+='<tr>\
                    ...
                    if (cart_details[i].options.recipe_type == 'nonveg') {
                        ...
                        <td style="width:10%">';
						if(cart_details[i].productcode=='undefined')
						{
						html +='</td>\
						<td style="width:10%">';
						}
						else if(cart_details[i].productcode=='NULL')
						{
						html +='</td>\
						<td style="width:10%">';
						}
						...
						{
						html +=cart_details[i].productcode+'</td>\
						<td style="width:10%">';
						}
                        if(cart_details[i].addon != null){
                        for(j=0;j<cart_details[i].addon.length;j++){
                            html +='<li>'+cart_details[i].addon[j].addon_name+'</li>'
                        }
                        }
                        html +='</td>\
                    <td style="width:25%">'+cart_details[i].options.special_notes+'</td>\
                    <td style="width:15%">\
                    ...
                    <td style="width:10%" class="text-right">'+Takeorders.currency_symbol+" "+cart_details[i].price+'</td>\
                    <td style="width:10%" class="font-weight-bold num-font text-right">'+Takeorders.currency_symbol+" "+cart_details[i].subtotal+'</td>\
                   </tr>';
                sub_total = parseFloat(sub_total) + parseFloat(cart_details[i].subtotal); 
        }
        tab_pan.find('.subtotal_html').html('Sub Total : '+Takeorders.currency_symbol+" "+ sub_total);
        tab_pan.find('.nettotal_html').html('Net Total : '+Takeorders.currency_symbol+" "+ sub_total);
        tab_pan.find('.net_total').val(sub_total);
        tab_pan.find('.sub_total').val(sub_total);
        tab_pan.find('.showaddeditems').html(html);
        tab_pan.find('.distotal_html').html('Discount Total : '+Takeorders.currency_symbol+" "+ 0);
    ...
    placeorder:function()
	{
		...
		/* if(tab_pane.find('.customer_name').val()!="" && tab_pane.find('.mobile_no').val()!="")
		{
			...
			{ */
				/* if (tab_pane.find('.mobile_no').val().length < 8 || tab_pane.find('.mobile_no').val().length > 14) 
				{ 
					Takeorders.displaywarning("Contact Number Should be 8 to 14 digit"); 
					$('#mobile_no').val()='';
				} */
				...
				$.ajax({
					...
					data:{
						...
						no_of_person:tab_pane.find('.number_of_person').val(),
    ...
    getorder:function(tab_pan){
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                tab_pan.find('.input-order-id').val(result['id']);
                tab_pan.find('.subtotal_html').html('Sub Total : '+Takeorders.currency_symbol+" "+ result['sub_total']);
                tab_pan.find('.distotal_html').html('Discount Total : '+Takeorders.currency_symbol+" "+ result['disc_total']);
                tab_pan.find('.nettotal_html').html('Net Total '+Takeorders.currency_symbol+" "+ result['net_total']);
                tab_pan.find('.total_html').html('Total '+Takeorders.currency_symbol+" "+ result['sub_total']);
                ...
                if(result['is_invoiced']==0){
                    ...
                    tab_pan.find('.cancel_order').hide();
            ...
            success: function(response)
			{
				...
				for(i in orders)
				{
                    if(i==0)
					{
                        ...
                        tab_pane.find('.subtotal_html').html('Sub Total : '+Takeorders.currency_symbol+" "+ result['sub_total']);
                        tab_pane.find('.distotal_html').html('Discount Total : '+Takeorders.currency_symbol+" "+ result['disc_total']);
						...
						tab_pane.find('.nettotal_html').html('Net Total '+Takeorders.currency_symbol+" "+ parseFloat(nettotal).toFixed('2'));
                        
						tab_pane.find('.total_html').html('Total '+Takeorders.currency_symbol+" "+ result['sub_total']);
                        ...
                        if(result['status'] != 'Canceled'){
							...
							tab_pane.find('.select-item-row').show();
                        }
                        else{
							tab_pane.find('.select-item-row').hide();
                                ...
                                tab_pane.find('.cancel_order').attr('disabled','');
                                tab_pane.find('.submit_order').hide();
                        }
                            tab_pane.find('.cancel_order').show();
						...
						{
                            tab_pane.find('.cancel_order').hide();
                            tab_pane.find('.cancel_order').attr('disabled','');
                            tab_pane.find('.td-payment').show();
                            tab_pane.find('.td-totaldetails').show();
                            tab_pane.find('.submit_order').show();
                        ...
                        if(result['invoice'])
						{
                            if(result['invoice'].length!=0)
							{
								...
								if(invoice_status=="Paid")
								{
									tab_pane.find('.cancel_order').hide();
									tab_pane.find('.select-item-row').hide();
									tab_pane.find('.show_discount_comment').html('<b>Discount Note - '+invoice_details['final_note']+'</b>');
									tab_pane.find('.show_discount_comment').show();
        ...
        if(response)
		{
            ...
            for (i in response) 
			{
                html += '<tr>\
                    ...
                    <td style="width:15%">';
					if(response[i].product_code=='undefined' || response[i].product_code==null)
					{
					html +='</td>\
                    <td style="width:10%">';
					}
					...
					{
					html +=response[i].product_code+'</td>\
                    <td style="width:10%">';
					}
                    ...
                    html +='</td>\
                    <td style="width:25%">'+response[i].special_notes+'</td>\
                    <td style="width:15%">\
                        <div class="input-group input-indec">\
                            <span class="input-group-btn">\
                    ...
                    <td style="width:10%">'+Takeorders.currency_symbol+" "+response[i].price+'</td>\
                    <td style="width:10%" class="font-weight-bold num-font text-right">'+Takeorders.currency_symbol+" "+response[i].sub_total+'</td>\
                </tr>';
            }
           tab_pan.find('.showaddeditems').html(html);
        }
